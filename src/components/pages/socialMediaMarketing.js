            ...
            <div className="container testi-margin">
                    ...
                    <div  className ="box col-xs-6 col-sm-6 col-md-6 col-lg-4 mt-4 ">
                        ...
                        <div className="row testi-margin justify-content-between ">
                            ...
                            <div   class="col-xs-12 col-sm-12 col-md-5 col-lg-5 align-self-center">
                                    <img className="wake-up-image" src={reward}   width="420px" />
                            </div>
                            ...
                            <div  class="heading-page-2 col-xs-12 col-sm-12 col-md-6 col-lg-6 ml-4">
                                    ...
                                    <button className="services-cta mt-3 mb-5f">Lets Get Started </button>          
                            </div>
                        </div>
                ...
                />
                    ...
                    <CtaFourth className="cta-image-right"
                        heading="Stand Out !!!"
                        subheading="Now is the time to distinguish your brand 
                        and capture high market share"
                        paragraph="Our team at ExpoBird is well-versed with needs and wants of brands for social media marketing.This will allow you to classify your niche in the right direction and earn greater market share for your product or service."
                        image={standOut}
