            ...
            <div> 
                <div className="row bnr">
                    ...
                    <div className="heading-text">
                        <h1 id="heading-main">Social Media<br/>Marketing</h1>
                        <p>Power up your Brand with Social Media Marketing from ExpoBird.<br/>
                            <span id="sub-text" >Call us now to revamp your Social Media </span>
                        </p>
                        <button className="rf">
                            Get Started
                        </button>
                ...
                <div className="row">
                    ...
                    <div className="col-2">
                        <img src={Image3}  width="219px" height="176px"/>
                        <img src={Image3}  width="219px" height="176px"/>
                    </div>                   
                    <div className="col-2">
                        <img src={Image3}  width="219px" height="176px"/>
                ...
                <div className="row3 row-container" >
                    ...
                    <div  className="margin-top col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
                            <h1 className="heading-page" >WAKE UP !</h1> 
                             <p className="text-secondary p-style">There can never be the right time to advertise your product or service on social media than now.
                                 You are playing your cards wrong if you have not considered going online yet. 
                                .</p>
                ...
                <div className="row">
                    <div  className ="box col-xs-6 col-sm-6 col-md-6 col-lg-3 mt-3 ">
                                <div class="margin-top1">
                                    ...
                                    <p class="p-style ">All builders and developers in Karachi and Pakistan have a strong profile. 
                                        This is primarily one of the reasons why you need to have a strong presence 
                                        for social media advertising. </p>
                                </div>
                    </div>
                    <div  className ="box col-xs-6 col-sm-6 col-md-6 col-lg-3 mt-3 ">
                                <div class="margin-top1">
                                    ...
                                    <p class="p-style ">All brands are selling their apparels on social media like hot cakes. 
                                Irrespective of their page likes, they are now of an opinion that their 
                                survival now relies more on online shopping stores than retail outlets.</p>
                                </div>
                    </div>
                    <div  className ="box col-xs-6 col-sm-6 col-md-6 col-lg-3 mt-3 ">
                                <div >
                                    ...
                                    <h3 class="h3-style "><br/>Fast Food Chains</h3>
                                ...
                                And why not? Fast food chains and restaurants
                                have a very strong customer base.</p>
                                </div>
                    </div>
                    <div  className ="box col-xs-6 col-sm-6 col-md-6 col-lg-3 mt-3 ">
                                <div >
                                    <svg viewBox="0 0 28 28" className="icon-small" >
                                            <path className="svg-color" d="M14,26l-.11,0S.42,21.52,0,10.58c0-.12,0-.21,0-.33s0,0,0-.06,0,0,0-.07H0A8.2,8.2,0,0,1,7.88,2,7.73,7.73,0,0,1,14,5.21Z"></path>
                                            <path className="svg-color1"  d="M14,26l.11,0S27.58,21.52,28,10.58c0-.12,0-.21,0-.33s0,0,0-.06,0,0,0-.07h0A8.2,8.2,0,0,0,20.12,2,7.73,7.73,0,0,0,14,5.21Z"></path>
                                    </svg>                            
                                    <h3 className="h3-style "><br/>Mobile and Accessories</h3>
                                    <p className="p-style ">In the last few years, we have witnessed many entrepreneurs introducing new smart 
                                phones in collaboration with different investors. These emerging brands set a 
                                very high budget for social media marketing all across Pakistan.</p>
                                </div>
                    </div>
                </div>
